...
export TASK_MANAGER_BASE="${TASK_MANAGER_BASE:-http://36.133.236.108:8090}"
export TASK_MANAGER_PROJECT="${TASK_MANAGER_PROJECT:-ultrashape}"
export ULTRASHAPE_OSS_BUCKET="${ULTRASHAPE_OSS_BUCKET:-kokokoni}"
export ULTRASHAPE_OSS_PREFIX="${ULTRASHAPE_OSS_PREFIX:-docker-input&output/ultrashape}"
...
export QUEUE_IDLE_PAUSE_DELAY_SEC="${QUEUE_IDLE_PAUSE_DELAY_SEC:-2}"
